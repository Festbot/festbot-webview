    ...
    return (
      <div>
        <div className={classes.container} style={this.props.isActive.Filter? {height: '44px'}:{height: '0'}}>
          <div className={classes.navigation}><LeftArrowIcon id={1} onClick={this.navigationClickHandler} style={{height:'100%',margin:'auto',width:'30px'}}/></div>
          <div id={this.props.activeStage} onClick={this.dropdownToggleHandler} className={classes.active} ><span className={classes.slidein}>{this.props.activeStage}</span></div>
          <div className={classes.navigation}><RightArrowIcon id={-1} onClick={this.navigationClickHandler} style={{height:'100%',margin:'auto',width:'30px'}} /></div>  
        </div>
